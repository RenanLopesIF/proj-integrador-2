...
import { Box, HStack, Avatar, Text, Badge, Flex, VStack, Image, Center, Button } from '@chakra-ui/react';
...
function Post(props) {
  ...
  const postDescription =
    'Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, at? Voluptatum cum quod eius magnam asperiores consequatur, consequuntur, tempora provident rerum quis perferendis! Nihil enim reprehenderit impedit aut corporis? Culpa.';
  const postImageUrlx =
    'https://valenews.com.br/wp-content/uploads/2021/10/FestivaldasCoresNovaGokula27102021FernandoNoronha.jpg';
    ...
    <Box borderRadius="10px" bgColor="#FFF" width="100%" minH="50px">
      <HStack alignItems="flex-start" justifyContent="space-between" w="full" padding={contentPadding}>
        ...
        <Flex alignItems="flex-end" flexDir="column" gap={1}>
          <Badge padding={1} colorScheme="yellow">
            Acontecendo agora
          </Badge>
        </Flex>
      </HStack>
      ...
      <Box padding={contentPadding}>
        ...
        <Box>
          ...
          <Flex justifyContent="space-between" alignItems="center">
            <Button color="primary.300" variant="unstyled" h="10" w="full">
              INTERESSEI
            </Button>
